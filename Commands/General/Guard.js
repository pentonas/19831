...
exports.run = async (client, message, args) => {
  ...
  if (args[0] === 'server' || args[0] === 'serverGuard') {
    ...
    message.channel.send(new Discord.MessageEmbed().setColor('2F3136').setFooter('pntonas').setFooter('pntonas', '').setThumbnail('')
...
exports.conf = {
  aliases: ['asfğalsmnflasmfğasf', 'asfashfpasğfjğasofasf'],
  permLevel: 0
};

exports.help = {
  name: 'asflmğasmnfğafsl',
};