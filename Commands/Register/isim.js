...
if(!isim) return message.channel.send(new MessageEmbed().setDescription(`Bir isim girmeyi unuttunuz. \`.i @pntonas./ID <İsim>\` `).setTimestamp().setFooter(Config.footer))
member.setNickname(`${kayıttabasagelecektag} ${isim}ˣˣˡ`)
