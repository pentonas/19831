...
let embed = new Discord.MessageEmbed().setFooter("pntonas").setTimestamp().setColor("010000").setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setTimestamp();
